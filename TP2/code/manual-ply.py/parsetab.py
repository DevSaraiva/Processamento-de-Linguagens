...
_lr_productions = [
  ...
  ('stat -> VAR = exp','stat',3,'p_stat','yacc.py',15),
  ('stat -> exp','stat',1,'p_stat_2','yacc.py',19),
  ('exp -> exp + exp','exp',3,'p_exp','yacc.py',23),
  ('exp -> exp - exp','exp',3,'p_exp_1','yacc.py',27),
  ('exp -> exp * exp','exp',3,'p_exp_2','yacc.py',31),
  ('exp -> exp / exp','exp',3,'p_exp_4','yacc.py',35),
  ('exp -> - exp','exp',2,'p_exp_6','yacc.py',39),
  ('exp -> ( exp )','exp',3,'p_exp_7','yacc.py',43),
  ('exp -> NUMBER','exp',1,'p_exp_8','yacc.py',47),
  ('exp -> VAR','exp',1,'p_exp_9','yacc.py',52),
]
