...
_lr_productions = [
  ...
  ('stat -> VAR = exp','stat',3,'p_stat','ex_yacc.py',14),
  ('stat -> exp','stat',1,'p_stat_2','ex_yacc.py',18),
  ('exp -> exp + exp','exp',3,'p_exp','ex_yacc.py',22),
  ('exp -> exp - exp','exp',3,'p_exp_1','ex_yacc.py',26),
  ('exp -> exp * exp','exp',3,'p_exp_2','ex_yacc.py',30),
  ('exp -> exp / exp','exp',3,'p_exp_4','ex_yacc.py',34),
  ('exp -> - exp','exp',2,'p_exp_6','ex_yacc.py',38),
  ('exp -> ( exp )','exp',3,'p_exp_7','ex_yacc.py',42),
  ('exp -> NUMBER','exp',1,'p_exp_8','ex_yacc.py',46),
  ('exp -> VAR','exp',1,'p_exp_9','ex_yacc.py',51),
]
