...
_lr_productions = [
  ...
  ('precedence -> <empty>','precedence',0,'p_precedence_empty','parser_yacc.py',259),
  ('precedences -> precedences tokenprecedence','precedences',2,'p_precedences_varios','parser_yacc.py',263),
  ('precedences -> <empty>','precedences',0,'p_precedences_vazio','parser_yacc.py',267),
  ('tokenprecedence -> LEFTBRACKET rl COMMA nametokensprec RIGHTBRACKET COMMA','tokenprecedence',6,'p_tokenprecedence','parser_yacc.py',271),
  ('rl -> SQM RIGHT SQM','rl',3,'p_rl_r','parser_yacc.py',275),
  ('rl -> SQM LEFT SQM','rl',3,'p_rl_l','parser_yacc.py',279),
  ('nametokensprec -> nametokensprec COMMA SQM UPPERWORD SQM','nametokensprec',5,'p_nametokensprec','parser_yacc.py',283),
  ('nametokensprec -> nametokensprec COMMA SQM CHAR SQM','nametokensprec',5,'p_nametokensprec_char','parser_yacc.py',287),
  ('nametokensprec -> SQM CHAR SQM','nametokensprec',3,'p_nametokensprec_char_single','parser_yacc.py',291),
  ('nametokensprec -> SQM UPPERWORD SQM','nametokensprec',3,'p_nametokensprec_upperword_single','parser_yacc.py',295),
  ('varsdesc -> HASHTAG words NEWLINE','varsdesc',3,'p_varsdesc','parser_yacc.py',300),
  ('vars -> varsdesc varsaux','vars',2,'p_vars','parser_yacc.py',306),
  ('varsaux -> <empty>','varsaux',0,'p_varsaux_empy','parser_yacc.py',312),
  ('varsaux -> varsaux var','varsaux',2,'p_varsaux','parser_yacc.py',316),
  ('var -> CONTENTVAR changeline','var',2,'p_var','parser_yacc.py',322),
  ('changeline -> NEWLINE','changeline',1,'p_changeline','parser_yacc.py',326),
  ('changeline -> DOUBLENEWLINE','changeline',1,'p_changeline2','parser_yacc.py',329),
  ('prods -> prods prod','prods',2,'p_prods','parser_yacc.py',335),
  ('prods -> <empty>','prods',0,'p_prods_empty','parser_yacc.py',339),
  ('prod -> WORD WORD expProd LEFTCOTTER CHARS RIGHTCOTTER','prod',6,'p_prod','parser_yacc.py',343),
  ('expProd -> expProd UPPERWORD','expProd',2,'p_expProd_token','parser_yacc.py',348),
  ('expProd -> expProd WORD','expProd',2,'p_expProd_terminal','parser_yacc.py',352),
  ('expProd -> expProd SQM CHAR SQM','expProd',4,'p_expProd_terminalLiteral','parser_yacc.py',356),
  ('expProd -> expProd SQM EQUAL SQM','expProd',4,'p_expProd_terminalEqual','parser_yacc.py',360),
  ('expProd -> expProd SQM LEFTBRACKET SQM','expProd',4,'p_expProd_leftbracket','parser_yacc.py',364),
  ('expProd -> expProd SQM RIGHTBRACKET SQM','expProd',4,'p_expProd_rightbracket','parser_yacc.py',368),
  ('expProd -> expProd markerPrec','expProd',2,'p_expProd_markerPrec','parser_yacc.py',373),
  ('expProd -> <empty>','expProd',0,'p_expProd_vazio','parser_yacc.py',377),
  ('markerPrec -> PRECTAG UPPERWORD','markerPrec',2,'p_markerPrec','parser_yacc.py',381),
  ('functionsyacc -> functionsyacc functionyacc','functionsyacc',2,'p_functionsyacc','parser_yacc.py',388),
  ('functionsyacc -> <empty>','functionsyacc',0,'p_functionsyacc_empty','parser_yacc.py',392),
  ('functionyacc -> FUNCTION BODYFUNCTIONLINE bodyfunction BODYFUNCTIONFINAL','functionyacc',4,'p_functionyacc','parser_yacc.py',396),
  ('bodyfunction -> bodyfunction BODYFUNCTIONLINE','bodyfunction',2,'p_bodyfunction','parser_yacc.py',400),
  ('bodyfunction -> <empty>','bodyfunction',0,'p_bodyfunction_empty','parser_yacc.py',404),
  ('parse -> WORD LEFTBRACKET CHARACTERS RIGHTBRACKET','parse',4,'p_parse','parser_yacc.py',408),
  ('inityacc -> WORD EQUAL INITYACC','inityacc',3,'p_inityacc','parser_yacc.py',413),
]
